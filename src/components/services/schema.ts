...
export const services: IService[] = [
  {
    ...
    intro:
      "Scalable and reliable virtual servers hosted in the cloud, providing flexible resources to meet your computing needs.",
    icon: "Server",
    href: "/secure-servers",
  },
  {
    ...
    intro:
      "Secure and efficient data storage solutions that enable easy access, management, and retrieval of information for your applications.",
    icon: "Database",
    href: "/database",
  },
  {
    ...
    intro:
      "Streamlined invoicing software that automates billing processes, tracks payments, and simplifies financial management for businesses.",
    icon: "Invoice",
    href: "/invoicing",
  },
  {
    ...
    description:
      "Enhance your application's functionality with our webhook service, which enables real-time data exchange between different systems. Webhooks allow your applications to send and receive notifications automatically, facilitating seamless integration with third-party services and APIs. Whether you need to trigger actions based on specific events or synchronize data across platforms, our webhook solution provides a reliable and efficient way to automate workflows. With easy setup and customizable payloads, you can streamline processes and improve overall efficiency.",
    intro:
      "Real-time communication tools that allow your applications to send and receive data automatically, enabling seamless integration and automation.",
    icon: "Webhooks",
    href: "/webhooks",
  },
];
