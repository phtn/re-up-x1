  ...
  return (
    <section>
      <HyperList
        data={services}
        component={Service}
        container="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 portrait:md:h-[38rem] portrait:md:grid-cols-2 w-full h-fit xl:h-72 relative z-50 dark:border-primary/10 border-primary/60 border-y"
